<ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="#"><i class="la la-server"></i><span class="menu-title" data-i18n="Components">User Management</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="user_index.php"><i></i><span data-i18n="Alerts">User List</span></a>
                        </li>
                    </ul>
                </li>
                <?php endif; ?>
                <li class=" nav-item"><a href="#"><i class="la la-unlock"></i><span class="menu-title" data-i18n="Authentication">Product Management</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="category_index.php" target="_blank"><i></i><span>Product Category</span></a>
                        </li>
                        <li><a class="menu-item" href="product_index.php" target="_blank"><i></i><span>Shop Product</span></a>
                        </li>
                    </ul>
                </li>
