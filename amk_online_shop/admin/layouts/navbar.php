            ...
            <div class="navbar-container content">
                <div class="collapse navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"><span class="mr-1 user-name text-bold-700"><?= $auth->user_name ?></span><span class="avatar avatar-online"><img src="../_actions/profile/<?= $auth->profile_img ?>" alt="avatar"><i></i></span></a>
                            <div class="dropdown-menu dropdown-menu-right">
                                <?php 
                                    if($auth->value==1){?>
                                        <a class="dropdown-item" href="admin_profile.php"><i class="ft-user"></i>Admin Profile</a>
                                <?php
                                    }else if($auth->value==2){?>
                                        <a class="dropdown-item" href="user_profile.php"><i class="ft-user"></i>User Profile</a>
                                <?php
                                    }
                                ?>
                                <a class="dropdown-item" href="#"><i class="ft-clipboard"></i> Todo</a>
                                <a class="dropdown-item" href="#"><i class="ft-check-square"></i> Task</a>
                                <div class="dropdown-divider"></div><a class="dropdown-item" href="../_actions/logout.php"><i class="ft-power"></i> Logout</a>
                            </div>
                        </li>
                    </ul>
                </div>
