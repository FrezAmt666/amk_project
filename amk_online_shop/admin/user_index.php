                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <span>
                                                                ...
                                                                <form action="../_actions/change_role.php" method="post">
                                                                    ...
                                                                    <?php if($auth->value == 1) : ?>
                                                                    <select name="role_id" id="role" calss="form-control">
                                                        ...
                                                        <td>
                                                            ...
                                                            <!-- ban form -->
                                                            <span class="btn btn-sm btn-priamry">
                                                            ...
                                                            <span class="btn btn-primry btn-sm">
                                                                <!-- approve form -->
                                                        ...
                                                        <td>
                                                            <a href="user_show.php?id=<?= $user->id ?>" class="btn btn-sm btn-warning">Show</a>
                                                        <?php if($auth->value == 1) : ?>
