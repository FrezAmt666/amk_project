                                ...
                                <div class="card-content">
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal" action="_actions/user_create.php" method="post" novalidate>
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input type="text" class="form-control" name="public_name" id="user-name" placeholder="Public Name">
                                                <div class="form-control-position">
                                                    <i class="la la-user"></i>
                                                </div>
                                            </fieldset>
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input type="email" class="form-control" name="email" id="user-email" placeholder="Your Email Address" required>
                                                <div class="form-control-position">
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input type="text" class="form-control" name="address" id="user-name" placeholder="Address">
                                                <div class="form-control-position">
                                                    <i class="la la-user"></i>
                                                </div>
                                            </fieldset>
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input type="text" class="form-control" name="company"  id="user-name" placeholder="Company">
                                                <div class="form-control-position">
                                                    <i class="la la-user"></i>
                                                </div>
                                            </fieldset>
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input type="date" class="form-control" name="date_of_birth" id="user-name" placeholder="Date Of Birth">
                                                <div class="form-control-position">
                                                    <i class="la la-user"></i>
                                                </div>
                                            </fieldset>
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left">
                                                         <select  id="projectinput6" name="state" class="form-control">
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input type="text" class="form-control" name="language" id="user-name" placeholder="Language">
                                                <div class="form-control-position">
                                                    <i class="la la-user"></i>
                                                </div>
                                            </fieldset>
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left">
                                                         <select  id="projectinput6" name="fav_movie" class="form-control">
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left">
                                                         <select  id="projectinput6" name="fav_music" class="form-control">
                                                            <option value="none" selected="" disabled="">Choose Fav Musics</option>
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input type="text" class="form-control" name="website" id="user-name" placeholder="Website">
                                                <div class="form-control-position">
                                                    <i class="la la-user"></i>
                                                </div>
                                            </fieldset>
